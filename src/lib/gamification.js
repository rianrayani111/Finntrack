...
// ============================================================
// Badge eligibility (the check() functions below) is evaluated server-side
// only -- see finn_evaluate_badges in migration 0026_server_side_badge_eligibility.sql.
// check() stays on each catalogue entry as documentation of the SQL it
// mirrors, but nothing in this app calls it: syncAchievements() just asks
// the server what's earned and displays that. CATEGORY_LIST is still live --
// several check() bodies below reference it even though they never run.
// ============================================================
