...
export default function Dashboard() {
  ...
  if (loadError) {
    // Never fall through to the normal view on a failed load: it would render
    // a confident "$0.00 / No transactions yet", which reads to a kid as their
    // money having disappeared.
    return (
      <div className="finn-card text-center py-10">
        <p className="text-slate-700 font-bold">Could not load your dashboard</p>
